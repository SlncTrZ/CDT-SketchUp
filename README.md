...
> Current provider version: `0.1.0` · Contract: `0.30`
...
The current public tree automated suite is **230 PASS, 2 SKIP**. The skips are environment-specific optional checks and do not suppress contract coverage.
