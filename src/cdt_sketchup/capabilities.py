...
CAPABILITY_DESCRIPTORS: tuple[CapabilityDescriptor, ...] = (
    ...
    _strict(
        ...
        destructive=True,
        identity="caller_operation_id_optional_action_defined",
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="bounded_journal_replay_when_operation_id_supplied",
    ...
    _strict(
        "create_polyline",
        "sketchup.geometry.polyline_create",
        destructive=False,
        identity="new_group_edge_chain",
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="not_idempotent",
    ...
    _strict(
        "create_rectangle",
        "sketchup.geometry.rectangle_create",
        destructive=False,
        identity="new_group_rectangle",
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="not_idempotent",
        preconditions=("if_context",),
    ),
    _strict(
        "create_circle",
        "sketchup.geometry.circle_create",
        destructive=False,
        identity="new_group_circle",
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="not_idempotent",
        preconditions=("if_context",),
    ),
    _strict(
        "create_arc",
        "sketchup.geometry.arc_create",
        destructive=False,
        identity="new_group_arc",
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="not_idempotent",
        preconditions=("if_context",),
    ),
    _strict(
        "create_polygon",
        "sketchup.geometry.polygon_create",
        destructive=False,
        identity="new_group_polygon",
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="not_idempotent",
        preconditions=("if_context",),
    ),
    ...
    _strict(
        ...
        destructive=False,
        identity="profile_path_reparented_new_group_pid",
        units="none",
        idempotence="not_idempotent",
        limits={"max_path_edges": 64},
        preconditions=("if_context", "if_match_set"),
    ),
    _read(
        "measure_distance",
    ...
    _read(
        "query_topology",
        "sketchup.topology.connected",
        identity="persistent_id_exact",
        units="none",
        limits={"max_topology_results": 500},
        receipt_kind="query",
    ),
    _read(
        "query_overlap",
    ...
    _strict(
        ...
        "sketchup.material.texture_apply",
        destructive=False,
        identity="material_name_same",
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="assignment_replay_safe",
        limits={"max_texture_bytes": 16777216},
        preconditions=("if_context",),
    ),
    _read(
        "material_info",
        "sketchup.material.info",
        identity="material_name_exact",
        units="explicit:mm|cm|m|in|ft|model",
        receipt_kind="query",
    ),
    _read(
        "camera_get",
        "sketchup.camera.view",
        identity="active_view_camera",
        units="explicit:mm|cm|m|in|ft|model",
        receipt_kind="query",
    ),
    _strict(
        ...
        units="explicit:mm|cm|m|in|ft|model",
        idempotence="absolute_replay_safe",
        preconditions=("if_context", "if_match"),
    ),
    _read(
        "scene_list",
        "sketchup.scene.list",
        identity="scene_registry",
        units="none",
        receipt_kind="query",
    ),
    _strict(
        "scene_create",
        "sketchup.scene.create",
        destructive=False,
        identity="new_page_name",
        units="none",
        idempotence="not_idempotent",
        preconditions=("if_context",),
    ),
    ...
    _read(
        "integrity_report",
        "sketchup.integrity.report",
        identity="model_scan",
        units="none",
        limits={"max_integrity_scan": 5000},
        receipt_kind="query",
    ),
    _strict(
        "repair_reverse_face",
        "sketchup.integrity.reverse_face",
        destructive=False,
        identity="persistent_id_same",
        units="none",
        idempotence="toggle_not_idempotent",
        preconditions=("if_context", "if_match"),
    ),
    _strict(
        "repair_erase_degenerate",
        "sketchup.integrity.erase_degenerate",
        destructive=True,
        identity="persistent_id_consumed",
        units="none",
        idempotence="not_idempotent",
